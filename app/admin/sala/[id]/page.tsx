                ...
                <SidebarHeader className="border-b pb-4 pt-6 px-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col gap-0.5 leading-none">
                            ...
                            <span className="text-sm text-zinc-500 font-mono">Cód: {sala.codigo}</span>
                        </div>
                    </div>
                </SidebarHeader>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="bg-primary/5 p-8 rounded-xl text-center border border-primary/10 shadow-sm mb-4">
                                            ...
                                            <p className="text-sm text-zinc-600 mt-2 font-medium tracking-wide">CONVIDADOS CONECTADOS</p>
                                        </div>
                                        {participantes.length > 0 && (
                                            <div className="max-h-[300px] overflow-y-auto space-y-2 custom-scrollbar">
                                                {participantes.map((p) => (
                                                    <div key={p.id} className="flex items-center justify-between p-3 bg-white rounded-lg border shadow-sm hover:border-red-200 transition-colors group">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="flex items-center justify-between p-4 bg-white rounded-lg border shadow-sm transition-all hover:border-primary/50">
                                            <div><Label className="text-base font-bold">Jogo: Jujubas</Label><p className="text-xs text-zinc-500">Abre a tela de palpites no celular.</p></div>
                                            <Switch checked={sala.jogo_jujubas_ativo} onCheckedChange={(val) => toggleConfig('jogo_jujubas_ativo', val)} />
                                        </div>
                                        <div className="flex items-center justify-between p-4 bg-white rounded-lg border shadow-sm transition-all hover:border-primary/50">
                                            <div><Label className="text-base font-bold">Jogo: Mais Provável</Label><p className="text-xs text-zinc-500">Libera as perguntas do quiz.</p></div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                <div className="lg:col-span-2 space-y-6">
                                    <Card>
                                        ...
                                        <CardContent className="space-y-4">
                                            <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-4 bg-white rounded-lg border shadow-sm">
                                                <div className="w-full">
                                                    <Label className="text-base font-bold text-zinc-800">Gabarito (Total Real de Jujubas)</Label>
                                                    <p className="text-xs text-zinc-500 mb-2">Digite o valor exato para o sistema calcular o Ranking.</p>
                                                    <Input
                                                        type="number"
                                            ...
                                            <div className="flex items-center justify-between p-4 bg-white rounded-lg border shadow-sm">
                                                <div className="space-y-0.5">
                                                    ...
                                                    <p className="text-xs text-zinc-500">Revela o resultado na tela final do convidado.</p>
                                                </div>
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <div className="bg-zinc-100/50 p-8 rounded-xl flex items-center justify-between border">
                                                <div>
                                                    <p className="text-lg font-medium text-zinc-800">Total Recebido</p>
                                                    <p className="text-sm text-zinc-500">Palpites enviados até o momento</p>
                                                </div>
                                ...
                                <Card className="lg:col-span-1 scroll-m-2.5 max-h-[400px] overflow-y-auto ">
                                    ...
                                    <CardContent className="pr-2 custom-scrollbar">
                                        {rankingAtual.length === 0 ? (
                                            <div className="text-center text-sm text-zinc-500 py-8">Nenhum palpite recebido ainda.</div>
                                        ) : (
                        ...
                        <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
                            ...
                            <Card>
                                ...
                                <CardContent className="pt-6">
                                    {candidatos.length === 0 ? (
                                        <div className="text-center py-6 text-zinc-500 bg-zinc-50 rounded-lg border border-dashed">Cadastre as pessoas que vão participar do jogo!</div>
                                    ) : (
                                        <div className="flex flex-wrap gap-3">
                                            {candidatos.map((candidato) => (
                                                <div key={candidato.id} className="flex items-center gap-2 bg-white border shadow-sm px-4 py-2 rounded-full">
                                                    <span className="font-medium text-zinc-800">{candidato.nome}</span>
                            ...
                            <Card>
                                ...
                                <CardContent className="pt-6">
                                    {perguntas.length === 0 ? (
                                        <div className="text-center py-12 text-zinc-500 bg-zinc-50 rounded-lg border border-dashed">Nenhuma pergunta cadastrada. Comece adicionando a primeira!</div>
                                    ) : (
                                        <Table>
                                            <TableHeader>
                                                <TableRow className="bg-zinc-50"><TableHead className="font-semibold text-zinc-800">Pergunta</TableHead><TableHead className="text-right font-semibold text-zinc-800">Ações</TableHead></TableRow>
                                            </TableHeader>
                                            <TableBody>
